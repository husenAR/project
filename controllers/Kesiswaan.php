...
class Kesiswaan extends CI_Controller {
	...
	public function index()
	{
		...
		$data['totaluserpg'] = $usersNo->pg - $usersNo->ps;
		$data['totaluserpk'] = $usersNo->pk - $usersNo->ps;
	...
	public function distribusi_reg(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;  
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan//distribusi_reg' ,$data);
	}
	...
	public function pembagian() {
		...
		if ($tipe == "Berdasarkan Agama dan Jenis Kelamin") {
			...
			$data['foto'] = $this->session->foto;
			$data['username'] = $this->session->username;  		
			$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan//pembagian_agama', $data);
		} else {
			$data['nama'] = $this->session->Nama;
			$data['foto'] = $this->session->foto;
			$data['username'] = $this->session->username;  
			$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/pembagian_prestasi', $data);
		}
	}
	...
	public function hasil_pembagian_agama(){
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/hasil_pembagian_agama', $data);	
	}
	...
	public function hasil_pembagian_prestasi(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/hasil_pembagian_prestasi',$data);	
	}
	...
	public function distribusi_tam(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/distribusi_tam', $data);
	}
	...
	public function hasil_pembagian_tambahan(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/hasil_pembagian_tambahan', $data);	
	}
	...
	public function klinik_un(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/klinik_un', $data);
	}
	...
	public function hasil_klinik_un() {
		...
		redirect('kesiswaan/distribusi/klinik_un');
	...
	public function mutasi_masuk(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/mutasi_masuk', $data);
	...
	public function simpan_form_mutasi() 
	{
		...
		redirect('kesiswaan/distribusi/mutasi_masuk');
	}
	...
	public function mutasi_keluar(){
		...
		$data['foto'] = $this->session->foto; 
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/mutasi_keluar',$data);
	}
...
// tutup anggrek
	public function ppdbujian(){
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/ppdbujian', $data);
	}
	...
	public function ppdbneg(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/ppdbneg', $data);
	}
	...
	public function daftarulang(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('kesiswaan/dashboard','superadmin/rancang/daftarulang', $data);
	...
	public function daftarkenaikan(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/daftarkenaikan', $data);
	...
	public function bukuinduk(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('kesiswaan/dashboard','superadmin/kesiswaan/bukuinduk', $data);
	}
	...
	public function mapel()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/mapel', $data);
	...
	public function harirentang()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/harirentang', $data);
	}
	...
	public function jammengajar()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/jammengajar', $data);
	}
	...
	public function simpanjammengajar() 
	{
		...
		redirect('kesiswaan/jammengajar');
	}
	...
	public function jadwalmapel()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/jadwalmapel', $data);
	}
	...
	public function jadwalpiketguru()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/jadwalpiketguru', $data);
	}
	...
	public function simpanjadwalpiketguru() 
	{
		...
		redirect('kesiswaan/jadwalpiketguru');
	}
	...
	public function jadwaltambahan($id_jadwal_tambahan = "")
	{
		...
		if ($id_jadwal_tambahan == "" ) {
			...
			$data['nama'] = $this->session->Nama;
			$data['foto'] = $this->session->foto;
			$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/jadwaltambahan', $data);
		} else {
			$this->load->model('penjadwalan/mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('penjadwalan/mod_namamapel');
	...
	public function hapusjadwaltambahan() {
		...
		redirect('kesiswaan/jadwaltambahan');
	}
	...
	public function getmapelkelastambahan()
	{
		...
		$this->template->load('kesiswaan/dashboard','penjadwalan/kurikulum/jadwaltambahan', $data);
	}
	...
	public function ekstrakurikuler($id_jadwal_ekskul = "")
	{
		if ($id_jadwal_ekskul == "" ) {
			...
			$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/ekstrakurikuler', $data);
		} else {
			$this->load->model('penjadwalan/mod_jadwalekskul');
			$data['tabel_jadwalekskul'] = $this->mod_jadwalekskul->get();
			$data['nama'] = $this->session->Nama;
	...
	public function hapusjadwalekskul() {
		...
		redirect('kesiswaan/ekstrakurikuler');
	}
	...
	public function namamapel($id_namamapel = "")
	{
		if ($id_namamapel == "" ) {
			...
			$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penjadwalan/namamapel', $data);
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
			...
			$this->template->load('kesiswaan/dashboard','superadmin/penjadwalan/kurikulum/namamapel', $data);
		}
...
// Penilaian Hafiz
	...
	public function kaldik(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/kaldik',$data);
	}
	...
	public function kurikulum(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/kurikulum',$data);
	}
	...
	public function nilaisiswa(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/nilaisiswa',$data);
	}
	...
	public function kategorinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/kategorinilai',$data);
	}
	...
	public function jenisnilaiakhir(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/jenisnilaiakhir',$data);
	}
	...
	public function deskripsinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/deskripsinilai',$data);
	}
	...
	public function rapor(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kesiswaan/dashboard', 'kepsek/rancang/Rapor',$data);
	}
	...
	public function presensi_siswa()
	{
		...
		$this->template->load('kesiswaan/dashboard','superadmin/kurikulum/penilaian/presensisiswa', $data);
	}
	...
	public function submitpresensisiswa(){
		...
		redirect('kepsek/presensi_siswa');
...
//tutup Hafiz
	...
	public function pendaftaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/pembimbing/pendaftaran', $data);
	}
	...
	public function jadwal(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/pembimbing/jadwal', $data);
	}
	...
	public function presensi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/pembimbing/presensi', $data);
	}
	...
	public function nilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/pembimbing/nilai', $data);
	}
	...
	public function pembayaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/pembimbing/pembayaran', $data);
	}
	// TUTUP PEMBIMBING
	...
	public function keterlambatan(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/konseling/keterlambatan', $data);
	}
	...
	public function absensi_harian(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/konseling/absensi_harian', $data);
	}
	...
	public function pelanggaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/konseling/pelanggaran', $data);
	}
	...
	public function prestasi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kesiswaan/dashboard','kepsek/konseling/prestasi', $data);
	}
