...
class Konseling extends CI_Controller {
	...
	function __construct(){
		...
		if (($this->session->userdata('jabatan') != 'Pembimbing' ) && ($this->session->userdata('jabatan') != 'Konseling' ) ) {
	...
	public function pendaftaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/pembimbing/pendaftaran', $data);
	}
	...
	public function jadwal(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/pembimbing/jadwal', $data);
	}
	...
	public function presensi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/pembimbing/presensi', $data);
	}
	...
	public function nilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/pembimbing/nilai', $data);
	}
	...
	public function pembayaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/pembimbing/pembayaran', $data);
	}
	// TUTUP PEMBIMBING
	...
	public function keterlambatan(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/konseling/keterlambatan', $data);
	}
	...
	public function absensi_harian(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/konseling/absensi_harian', $data);
	}
	...
	public function pelanggaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/konseling/pelanggaran', $data);
	}
	...
	public function prestasi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','superadmin/konseling/prestasi', $data);
	}
	...
	public function ppdbujian(){
		...
		$this->template->load('konseling/dashboard','kepsek/kesiswaan/ppdbujian', $data);
	}
	...
	public function ppdbneg(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('konseling/dashboard','kepsek/kesiswaan/ppdbneg', $data);
	}
	...
	public function daftarulang(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('konseling/dashboard','kepsek/kesiswaan/daftarulang', $data);
	...
	public function daftarkenaikan(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('konseling/dashboard','kepsek/kesiswaan/daftarkenaikan', $data);
	...
	public function bukuinduk(){
		...
		$this->load->model('kesiswaan/model_pendaftar_ppdb');
		$data['tabel_pendaftar_ppdb_lolos'] = $this->model_pendaftar_ppdb->getlolos($tahun_aktif);
		$this->template->load('konseling/dashboard','superadmin/kesiswaan/bukuinduk', $data);
	}
...
// Nadya Aya 
	...
	public function distribusi_reg(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','kepsek/rancang/distribusi_reg', $data);
	}
	...
	public function distribusi_tam(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','kepsek/rancang/distribusi_tam', $data);
	}
	...
	public function klinik_un(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','kepsek/rancang/klinik_un', $data);
	}
	...
	public function mutasi_masuk(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','kepsek/rancang/mutasi_masuk', $data);
	}
	...
	public function mutasi_keluar(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard','kepsek/rancang/mutasi_keluar', $data);
	}
	...
	public function kaldik(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('konseling/dashboard', 'kepsek/rancang/kaldik',$data);
	}
	...
	public function kurikulum(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/kurikulum',$data);
	}
	...
	public function nilaisiswa(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/nilaisiswa',$data);
	}
	...
	public function kategorinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/kategorinilai',$data);
	}
	...
	public function jenisnilaiakhir(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/jenisnilaiakhir',$data);
	}
	...
	public function deskripsinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/deskripsinilai',$data);
	}
	...
	public function rapor(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('konseling/dashboard', 'kepsek/rancang/Rapor',$data);
	}
	...
	public function presensi_siswa()
	{
		...
		$this->template->load('konseling/dashboard','superadmin/kurikulum/penilaian/presensisiswa', $data);
	}
