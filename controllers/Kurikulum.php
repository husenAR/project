...
// tutup anggrek
	...
	public function mapel()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/mapel', $data);
	...
	public function harirentang()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/harirentang', $data);
	}
	...
	public function jammengajar()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/jammengajar', $data);
	}
	...
	public function jadwalmapel()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/jadwalmapel', $data);
	}
	...
	public function jadwalpiketguru()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/jadwalpiketguru', $data);
	}
	...
	public function jadwaltambahan($id_jadwal_tambahan = "")
	{
		...
		if ($id_jadwal_tambahan == "" ) {
			...
			$data['nama'] = $this->session->Nama;
			$data['foto'] = $this->session->foto;
			$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/jadwaltambahan', $data);
		} else {
			$this->load->model('penjadwalan/mod_kelastambahan');
			$data['tabel_kelastambahan'] = $this->mod_kelastambahan->get();
			$this->load->model('penjadwalan/mod_namamapel');
	...
	public function getmapelkelastambahan()
	{
		...
		$this->template->load('kurikulum/dashboard','penjadwalan/kurikulum/jadwaltambahan', $data);
	}
	...
	public function ekstrakurikuler($id_jadwal_ekskul = "")
	{
		if ($id_jadwal_ekskul == "" ) {
			...
			$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/ekstrakurikuler', $data);
		} else {
			$this->load->model('penjadwalan/mod_jadwalekskul');
			$data['tabel_jadwalekskul'] = $this->mod_jadwalekskul->get();
			$data['nama'] = $this->session->Nama;
	...
	public function namamapel($id_namamapel = "")
	{
		if ($id_namamapel == "" ) {
			...
			$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penjadwalan/namamapel', $data);
		} else {
			$this->load->model('penjadwalan/mod_namamapel');
			...
			$this->template->load('kurikulum/dashboard','superadmin/penjadwalan/kurikulum/namamapel', $data);
		}
...
// Penilaian Hafiz
	...
	public function kaldik(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/kaldik',$data);
	}
	...
	public function kurikulum(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/kurikulum',$data);
	}
	...
	public function nilaisiswa(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/nilaisiswa',$data);
	}
	...
	public function kategorinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/kategorinilai',$data);
	}
	...
	public function jenisnilaiakhir(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/jenisnilaiakhir',$data);
	}
	...
	public function deskripsinilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/deskripsinilai',$data);
	}
	...
	public function rapor(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username; 
		$this->template->load('kurikulum/dashboard', 'kepsek/rancang/Rapor',$data);
	}
	...
	public function presensi_siswa()
	{
		...
		$this->template->load('kurikulum/dashboard','superadmin/kurikulum/penilaian/presensisiswa', $data);
	}
...
//tutup Hafiz
	...
	public function pendaftaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/pembimbing/pendaftaran', $data);
	}
	...
	public function jadwal(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/pembimbing/jadwal', $data);
	}
	...
	public function presensi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/pembimbing/presensi', $data);
	}
	...
	public function nilai(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/pembimbing/nilai', $data);
	}
	...
	public function pembayaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/pembimbing/pembayaran', $data);
	}
	// TUTUP PEMBIMBING
	...
	public function keterlambatan(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/konseling/keterlambatan', $data);
	}
	...
	public function absensi_harian(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/konseling/absensi_harian', $data);
	}
	...
	public function pelanggaran(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/konseling/pelanggaran', $data);
	}
	...
	public function prestasi(){
		...
		$data['foto'] = $this->session->foto;
		$data['username'] = $this->session->username;
		$this->template->load('kurikulum/dashboard','kepsek/konseling/prestasi', $data);
	}
