        ...
        <ul class="sidebar-menu">
          ...
          if (in_array("1", $arrmenuakses)) {
                  ...
                  <li ><a href="#"><i class="fa fa-circle-o"></i> Penerimaan Peserta Didik Baru </a>
                   <ul class="treeview-menu">
                    ...
                    if (in_array("3", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>guru/ppdbujian"><i class="fa fa-circle-o text-red"></i> PPDB Ujian</a></li>
                      <?php
                    }
                    ?>
                    ...
                    if (in_array("4", $arrmenuakses)) {
                      ?>
                      <li ><a href="<?php echo base_url();?>guru/ppdbneg"><i class="fa fa-circle-o text-red"></i> PPDB UN</a></li>
                      <?php
                    }
                    ?>
                  </ul>
                ...
                <li ><a href="#"><i class="fa fa-circle-o"></i> Daftar Ulang </a> 
                 <ul class="treeview-menu">
                  ...
                  if (in_array("6", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>guru/daftarulang"><i class="fa fa-circle-o text-red"></i>Peserta Didik Baru</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("7", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>guru/daftarkenaikan"><i class="fa fa-circle-o text-red"></i>Kenaikan Kelas</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("11", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>guru/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
                    <?php
                  }
                  ?>
                </ul>
              ...
              <li><a href="#"><i class="fa fa-circle-o"></i> Mutasi </a>
                <ul class="treeview-menu">
                  ...
                  if (in_array("13", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>guru/mutasi_masuk"><i class="fa fa-circle-o text-red"></i> Mutasi Masuk</a></li>
                    <?php
                  }
                  ?>
                  ...
                  if (in_array("14", $arrmenuakses)) {
                    ?>
                    <li ><a href="<?php echo base_url();?>guru/mutasi_keluar"><i class="fa fa-circle-o text-red"></i> Mutasi Keluar</a></li>
                    <?php
                  }
                  ?>
                </ul>
            ...
            if (in_array("15", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>guru/bukuinduk"><i class="fa fa-circle-o"></i>Buku Induk</a></li>
              <?php
            }
            ?>
            ...
            <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
             <ul class="treeview-menu">
              ...
              if (in_array("27", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/kaldik"><i class="fa fa-circle-o text-red"></i> KALDIK</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("28", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/kurikulum"><i class="fa fa-circle-o text-red"></i> Kurikulum Sekolah</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("29", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Presensi Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("30", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/nilaisiswa"><i class="fa fa-circle-o text-red"></i> Nilai Siswa</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("31", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/kategorinilai"><i class="fa fa-circle-o text-red"></i> Kategori Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("32", $arrmenuakses)) {
                ?>
                <li ><a href="<?php echo base_url();?>guru/jenisnilaiakhir"><i class="fa fa-circle-o text-red"></i> Jenis Nilai Akhir</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("33", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/deskripsinilai"><i class="fa fa-circle-o text-red"></i> Deskripsi Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("34", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/rapor"><i class="fa fa-circle-o text-red"></i> Rapor</a></li>
                <?php
              }
              ?>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        ...
        if (in_array("36", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('guru/datapegawai');?>"><i class="fa fa-circle-o"></i>Data Pegawai</a></li>
          <?php
        }
        ?>
        ...
        if (in_array("37", $arrmenuakses)) {
          ?>
          <li><a href="<?php echo site_url('guru/presensipegawai');?>"><i class="fa fa-circle-o"></i>Presensi Pegawai</a></li>
          <?php
        }
        ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
            <ul class="treeview-menu">
              ...
              if (in_array("40", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/pendaftaran"><i class="fa fa-circle-o text-red"></i>Pendaftaran</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("41", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/jadwal"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("42", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/presensi"><i class="fa fa-circle-o text-red"></i> Presensi</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("43", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/nilai"><i class="fa fa-circle-o text-red"></i> Nilai</a></li>
                <?php
              }
              ?>
              ...
              if (in_array("44", $arrmenuakses)) {
                ?>
                <li><a href="<?php echo base_url();?>guru/pembayaran"><i class="fa fa-circle-o text-red"></i> Pendanaan</a></li>
                <?php
              }
              ?>
          ...
          <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Bimbingan Konseling</a>
           <ul class="treeview-menu">
            ...
            if (in_array("46", $arrmenuakses)) {
              ?>
              <li ><a href="<?php echo base_url();?>guru/keterlambatan"><i class="fa fa-circle-o text-red"></i> Keterlambatan & Jam</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("47", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>guru/absensi_harian"><i class="fa fa-circle-o text-red"></i> Perizinan</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("48", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>guru/pelanggaran"><i class="fa fa-circle-o text-red"></i> Pelanggaran</a></li>
              <?php 
            }
            ?>
            ...
            if (in_array("49", $arrmenuakses)) {
              ?>
              <li><a href="<?php echo base_url();?>guru/prestasi"><i class="fa fa-circle-o text-red"></i> Prestasi</a></li>
              <?php 
            }
            ?>
          </ul>
