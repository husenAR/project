          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url();?>/assets/distribusi/admin/image/admin.png" class="user-image" alt="User Image">
                <span class="hidden-xs">[nama siswa]</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="<?php echo base_url();?>/assets/distribusi/admin/image/admin.png" class="img-circle" alt="User Image">
