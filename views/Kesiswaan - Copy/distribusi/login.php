...
<?php echo form_open('distribusi/login/ceklogin')?>
      ...
      <div class="form-group"><input type="password" required="required" class="form-control" name="password" placeholder="Masukkan Password"></div>
