        ...
        <div class="col-md-12">
           <div class="nav-tabs-custom">
            ...
            <li><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Tambah Kelas</a>
                  ...
                  <form class="form-horizontal form-mapel" method="post" action="<?php echo base_url('distribusi/kesiswaan/pembagian'); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="tambahkelas">
                     ...
                     <a href="<?php echo site_url('distribusi/kesiswaan/pembagian_agama'); ?>"><button type="button" class="btn btn-primary">Agama</button></a>
                     <a href="<?php echo site_url('distribusi/kesiswaan/pembagian_prestasi'); ?>"><button type="button" class="btn btn-primary">Prestasi</button></a>
