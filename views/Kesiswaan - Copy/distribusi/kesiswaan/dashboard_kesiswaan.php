  ...
  <div class="wrapper">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="<?php echo site_url('distribusi/logout')?>" class="btn btn-default btn-flat">Log out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <aside class="main-sidebar">
      ...
      <li ><a href="distribusi.php"><i class="fa fa-circle-o"></i> Distribusi Kelas </a>
        <ul class="treeview-menu">
          <li ><a href="<?php echo base_url();?>distribusi/kesiswaan/distribusi_reg"><i class="fa fa-circle-o text-red"></i> Kelas Reguler </a></li>
          <li ><a href="<?php echo base_url();?>distribusi/kesiswaan/distribusi_tam"><i class="fa fa-circle-o text-red"></i> Kelas Tambahan </a></li>
          <li ><a href="<?php echo base_url();?>distribusi/kesiswaan/klinik_un"><i class="fa fa-circle-o text-red"></i> Klinik UN</a></li>
        </ul>

        <li><a href="mutasi.php"><i class="fa fa-circle-o"></i> Mutasi </a>
          <ul class="treeview-menu">
            <li ><a href="<?php echo base_url();?>distribusi/kesiswaan/mutasi_masuk"><i class="fa fa-circle-o text-red"></i> Mutasi Masuk</a></li>
            <li ><a href="<?php echo base_url();?>distribusi/kesiswaan/mutasi_keluar"><i class="fa fa-circle-o text-red"></i> Mutasi Keluar</a></li>
