            ...
            <div class="tab-content">
              ...
              <form>
               ...
               <form id="formmapel" style="display:block;" class="form-horizontal formmapel" method="post" action="<?php echo site_url('kurikulum/simpanmapel'); ?>">
                  ...
                  <input type="hidden" name="grade" id="grade"  value="<?php if (@$edit_mapel->grade != "") { echo @$edit_mapel->grade; } else { echo "grade 7"; } ?>"/>
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tr>
                        ...
                        <td><?php echo $row_mapel->grade; ?></td>
                        <td> 
                          <a class="btn btn-block btn-primary button-action btnedit" href="<?php echo site_url('kurikulum/mapel/'.$row_mapel->id_mapel); ?>" > Edit </a>
                          <a class="btn btn-block btn-primary button-action btnhapus" href="<?php echo site_url('kurikulum/hapusmapel/'.$row_mapel->id_mapel); ?>" > Hapus </a>
                        </td>               
                      </tr>
                      <?php
                      }
